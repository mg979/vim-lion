...
function! lion#alignRight(type, ...)
	call s:align('right', a:type, a:0, '', 0)
endfunction

function! lion#alignLeft(type, ...)
	call s:align('left', a:type, a:0, '', 0)
endfunction

function! lion#alignSqueezeRight(type, ...)
	call s:align('right', a:type, a:0, '', 1)
endfunction

function! lion#alignSqueezeLeft(type, ...)
